...
- **Billing: 16 / 50 entities done** (chunks 1-2 done; 3-9 pending). Full inventory + chunk
  status in `manifest.json`; next pending chunk is 3 (Product & ExtraService children).
